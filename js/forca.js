...
function mudarStyleLetra(tecla, condicao){
    if(condicao == false)
    {
        document.getElementById(tecla).style.background = "#FF0000"; // define a cor vermelha se errar a letra
        document.getElementById(tecla).style.color = "#ffffff"; // A letra muda pra cor branca
    }
    else{
        document.getElementById(tecla).style.background = "#0000FF"; // define a cor azul se acertar a letra
        document.getElementById(tecla).style.color = "#ffffff"; // A letra muda pra cor branca
    }
